...
$(document).ready(function () {
    ...
    var app = new Vue({
        ...
        methods: {
            ...
            getIniData: function getIniData() {
                return {
            ...
            frontEndDateFormat: function frontEndDateFormat(date) {
                return moment(date).format('MM/DD/YYYY');
            },
            serverDateFormat: function serverDateFormat(date) {
